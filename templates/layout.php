...
/** @var int|null $roomCount  active rooms besides the main one, badge on the Rooms tab (editors and admins) */
...
<div class="cabinet">
    <header class="dome">
        ...
        <nav class="nav" aria-label="<?= $e(t('Main navigation')) ?>">
            ...
            <?php endif; ?>
            <?php /* Every tab carries a counter: the Rooms tab -- editors and admins
                     only -- the active rooms besides the main one; the three public
